...
# 파이어베이스 객체 초기화
cred = credentials.Certificate('/home/pi/projectE/mykey2.json')
...
while(1):
	...
	if oldSpecial != newSpecial:
		if newSpecial == "Wave 1":
			waveMode1(newSpecial)
		elif newSpecial == "Wave 2":
			waveMode2(newSpecial)
		elif newSpecial == "Rainbow 1":
			rainbowMode1(newSpecial)
		elif newSpecial == "Rainbow 2":
	...
	if oldColor != newColor or oldBright != newBright:
		if newMood == "PowerON":
